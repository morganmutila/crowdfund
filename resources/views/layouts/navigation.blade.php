    ...
    <div class="container-lg">
        ...
        <div class="collapse navbar-collapse py-1" id="navbar">
            <ul class="navbar-nav me-2">
                <li class="nav-item"><a href="{{ url('/discover') }}" class="nav-link px-md-3 mx-2 text-dark fw-bold">Discover</a></li>
                <li class="nav-item"><a href="{{ url('/blog') }}" class="nav-link px-md-3 mx-2 text-dark fw-bold">Blog</a></li>              
            </ul>   
           
            <ul class="navbar-nav ms-md-auto">
                <li class="nav-item ms-md-auto">
                    <a href="{{ route('projects.create') }}" class="nav-link mx-2 px-md-3 text-dark fw-bold">Start a Project</a>
                </li>
                @auth
            ...
            @guest
                <ul class="navbar-nav">
                    <li class="nav-item"><a href="{{ route('login') }}" class="nav-link text-dark px-md-3 mx-2 fw-bold">Log In</a></li>
                    <li class="nav-item"><a href="{{ route('signup') }}" class="nav-link link-dark px-md-3 ms-md-2 btn btn-success text-white rounded">Sign Up</a></li>
                </ul>
            @endguest 
        </div>
    </div>
