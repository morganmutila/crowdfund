        ...
        <div class="collapse navbar-collapse py-1" id="navbar">
            <ul class="navbar-nav me-2">
                <li class="nav-item dropdown d-none d-md-inline-block">
                    <a class="nav-link px-md-3 mx-2 fw-bold text-dark dropdown-toggle" href="#" data-bs-toggle="dropdown">Browse<span class="ms-2"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="16" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
