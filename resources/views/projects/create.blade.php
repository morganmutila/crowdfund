			...
			<section class="row">
				<div class="col-12 d-flex justify-content-between align-items-center">
					...
					<div class="hstack float-end">
						<button class="btn btn-outline-secondary fw-bold ms-2 text-uppercase" type="reset">Cancel</button>
		...
		<section class="row">
			<div class="col-6">
				<form method="POST" action="{{ route('projects.store') }}" enctype="multipart/form-data">
					...
					<div class="row mb-5 d-flex justify-content-between">
						<div class="col-md-6 flex-md-grow-1">
						    ...
						    <div class="input-group w-100">
						    	<input type="text" class="form-control text-end" id="ProjectDuration" name="duration" value="{{ old('duration', 7) }}">
	    				...
	    				<div class="col-md-6">
						    ...
						    <div class="input-group w-100">
						    	...
						    	<input type="text" class="form-control w-25" id="ProjectBudget" name="budget"  value="{{ old('budget', 0000) }}">
							</div>	
					...
					<div class="hstack float-end">
						<button class="btn btn-link fw-bold text-secondary text-decoration-none text-uppercase" type="reset">Cancel</button>
